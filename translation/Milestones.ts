...
export default milestones = {
	...
	[Milestone.Merchant]: ["Merchant", "Bartered with 100 items."],
	[Milestone.Navigator]: ["Navigator", "Traversed the seas in search of new lands."],
	[Milestone.Notekeeper]: ["Notekeeper", "Jotted down a note for each situation."],
	[Milestone.Pacifier]: ["Pacifier", "Tamed one of each tamable creature."],
