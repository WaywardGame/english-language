...
export default uiTranslations = {
	...
	[Ui.GameInterruptItemMayBeDestroyedInCraft]: "Items in the craft may be destroyed on failure.",
	...
	[Ui.GameInterruptSaveFailureDescription]: "Please create a topic and send us your logs on the <a href='https://steamcommunity.com/app/379210/discussions/1/'>Bug Reports Forum</a>",
	[Ui.GameInterruptLoadFailure]: "Failed to load the game",
	[Ui.GameInterruptLoadFailureDescription]: "Please create a topic and send us your logs on the <a href='https://steamcommunity.com/app/379210/discussions/1/'>Bug Reports Forum</a>",
	...
	[Ui.GameMessagesContextMenuClear]: "Clear All Messages",
	...
	[Ui.GameMultiplayerInterruptConnectingDescription]: "",
	...
	[Ui.MenuNewGameChoiceTurnsManual]: "Manual Turns",
	[Ui.MenuNewGameChoiceTurnsManualDescription]: "Turns only pass as players perform actions.",
	[Ui.MenuNewGameChoiceTurnsRealTime]: "Real-time Turns",
	[Ui.MenuNewGameChoiceTurnsRealTimeDescription]: "Turns happen automatically as time passes.",
	...
	[Ui.MenuOptionsButtonWarnWhenBreakingItemsOnCraft]: "On Craft",
	[Ui.MenuOptionsButtonWarnWhenBreakingItemsOnCraftTooltip]: "If checked, a confirmation screen will display when trying to craft using items that will break on failure.",
	...
	[Ui.MenuPauseButtonMultiplayer]: "Multiplayer",
	...
	[Ui.MenuPauseParagraphNotPaused]: "In multiplayer, the game does not pause.",
	...
	[Ui.MenuMultiplayerTitle]: "Multiplayer",
	[Ui.MenuMultiplayerDescription]: "Configure multiplayer settings.",
	[Ui.MenuMultiplayerOpenServer]: "Open Server",
	[Ui.MenuMultiplayerOpenServerDescription]: "Allow players to join your game.",

	[Ui.MenuMultiplayerPauseServer]: "Pause Server",
	[Ui.MenuMultiplayerPauseServerDescription]: "Pause or resume the game.",
	...
	[Ui.MenuSharedRealTimeTickSpeedTooltip]: "When the game is in real-time mode, the time it takes for a tick to occur.",
