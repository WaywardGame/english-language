...
export default items = {
	...
	[Item.PileOfCompost]: ["a", "pile of compost", "A mix of decaying organic matter, full of chemical nutrients and great for growing plants when combined with other fertilizer components.", "piles of compost"],
	...
	[ItemGroup.FireStarter]: ["a", "fire starter"],
