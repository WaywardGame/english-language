...
english.message(Message.WantToDeleteThisGame, " you want to delete this game?");
...
english.item(ItemType.MageCloak, "a ", "mage cloak", "An ancient tattered cloak, once owned by a spell casting foe.");
...
english.creature(CreatureType.SkeletalMage, "a ", "skeletal mage", "A cloaked, magic-casting skeletal humanoid. Its spell casting produces walls and teleportation.");
