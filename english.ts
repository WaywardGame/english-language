...
english.setDictionary(Dictionary.Message, {
	...
	[Message.DigUpDestroy]: "You dig up _0_ and destroy it in the process.",
	...
	[Message.HasBeenHurtByYourTrap]: "_0_ has been hurt by your trap, causing _1_ damage!",
	...
	[Message.NothingToGetFromThis]: "There is nothing to _0_ from this!",
	[Message.NothingUsefulToGetYet]: "There is nothing useful to _0_ from _1_ yet!",
...
english.setDictionary(Dictionary.Skill, {
	[Skill.Anatomy]: ["Anatomy", "<li>Increases accuracy of creature health description.</li><li>Decreases chance of bleeding and poisoning.</li><li>Increases effectiveness of healing consumables.</li><li>Increases success chance when healing.</li>"],
