...
english.message(Message.CollectObject, "Collect Object");
...
english.item(ItemType.WoodenPole, "wooden pole", "A long branch, carved and shaved down into a smooth rod.", "a ");
...
english.skill(SkillType.Anatomy, "Anatomy", "Increases accuracy of creature health information (via inspecting).<br />Decreases chance of bleeding and poisoning.<br />Increases effectiveness of healing consumables.<br />Increases success chance when healing.");
