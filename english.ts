...
english.message(Message.CollectObject, "Collect Object With Hands");
...
english.message(Message.DoodadAppearsDamaged, "The doodad appears have to have suffered a great deal of damage.");
english.message(Message.DoodadAppearsOnVergeOfBreaking, "The doodad is on the verge of breaking.");
english.message(Message.DoodadAppearsUnscathed, "The doodad appears to be unscathed.");
english.message(Message.DoodadCauseStatus, "The _0_ has _1_ you. You have lost _2_ health!");
english.message(Message.DoodadShowsSignsOfWear, "The doodad shows signs of wear.");
...
english.message(Message.NeedDeepWaterForRaft, "You need to be in deep water to use a raft.");
...
english.message(Message.RequiresYouToBeFacingTo, "This item requires you to be facing _0_ in order to _1_ it.");
...
english.message(Message.WelcomeToWayward21, `Welcome to Wayward beta 2.1.3!<br /><br />Please visit the <a href="https://steamcommunity.com/app/379210/allnews/" target="_blank">Steam Community News</a> section to see what's new.<br /><br /><span class="normal-size">All mods have been disabled by default.</span>`);
...
// Items
english.item(ItemType.Acorn, "acorn", "A hard tree nut with a cupule that can grow into a sapling when planted.", "an ");
...
english.item(ItemType.AnimalFatTorch, "animal fat torch", "A torch; wrapped in rendered animal fat, producing a long-lasting light source.", "an ");
english.item(ItemType.AnimalSkull, "animal skull", "A hollowed out, bleached animal skull, suitable for crafting into a provisional helmet.", "an ");
english.item(ItemType.Arrow, "arrow", "A projectile to be fired from a bow, crafted with an arrowhead and feather to control flight.", "an ");
english.item(ItemType.Backpack, "backpack", "Crafted with leather, it's suitable for holding many items on your back, reducing overall weight.", "a ");
english.item(ItemType.Bandage, "bandage", "A tattered piece of fabric, used to staunch wounds and prevent infection.", "a ");
...
english.item(ItemType.BarkShield, "bark shield", "A Makeshift shield, used to block incoming attacks, made with tree bark and wrapped with string.", "a ");
english.item(ItemType.BarkTorch, "bark torch", "A torch wrapped and bound by stripped tree bark, providing natural oils to increase the life of the torch.", "a ");
english.item(ItemType.BarkTunic, "bark tunic", "Tree bark chest armor bound together with string.", "a ");
english.item(ItemType.BerrySeeds, "berry seeds", "Black seeds that will grow into a berry bush, given enough time and care.");
english.item(ItemType.BigRedBerry, "big red berry", "An abnormally large, plump red berry, full of luscious nutrition.", "a ");
english.item(ItemType.BlackPowder, "black powder", "A highly combustible powder, made up of a combination of minerals.");
english.item(ItemType.BoatPaddle, "boat paddle", "A makeshift boat paddle used with boats and rafts, or combat if in dire need.", "a ");
english.item(ItemType.BoiledEgg, "boiled egg", "A moist, delicious boiled egg. Great tasting and packed with protein.", "a ");
english.item(ItemType.Bone, "bone", "A heavy, sun-bleached animal bone, suitable for rudimentary combat, gathering, or crafting into more useful items.", "a ");
english.item(ItemType.BoneNeedle, "bone needle", "A thin, hard, sharp needle, carved from bone.", "a ");
english.item(ItemType.BonePole, "bone pole", "A smooth cudgel crafted from a large bone.", "a ");
...
english.item(ItemType.Bow, "bow", "A bent wooden pole with a shorter string tied to both ends. The tension of the string is used to fire arrows.", "a ");
english.item(ItemType.BowDrill, "bow drill", "An advanced fire starting device. Uses the string on a bow to rotate into the wood, reducing much effort.", "a ");
english.item(ItemType.Branch, "branch", "A typical tree branch, useful for a variety of crafts or stoking a fire.", "a ");
english.item(ItemType.BullBoat, "bull boat", "A boat made from leather hides and framed with curved wooden poles. Used to travel to new, far away lands.", "a ");
english.item(ItemType.CactiSeeds, "cacti seeds", "These appear to be cactus seeds. Can be planted to grow cacti or eaten.");
english.item(ItemType.CactusNeedle, "cactus needle", "A needle from a cactus plant, useful in crafting smaller, more intricate items.", "a ");
english.item(ItemType.CactusSpines, "cactus spines", "Thin, long spikes, suitable for crafting into makeshift needles.");
english.item(ItemType.Campfire, "campfire", "A grouping of rocks shaped into a ring to contain a fire.", "a ");
...
english.item(ItemType.CharcoalBandage, "charcoal bandage", "A cloth bandage, coated in charcoal and used for its natural antiseptic and anticoagulant properties.", "a ");
english.item(ItemType.ClayBlowpipe, "clay blowpipe", "A sturdy blowpipe used for glassblowing.", "a ");
english.item(ItemType.ClayBrick, "clay brick", "A hardened clay brick, used in the building of structures such as floors and walls.", "a ");
...
english.item(ItemType.ClayBrickWall, "clay brick wall", "A wall made from clay bricks, set into a typical skewed, grid-like fashion to increase durability.", "a ");
...
english.item(ItemType.ClayJug, "clay jug", "A fully hardened clay jug with a cork. Used to hold water.", "a ");
english.item(ItemType.ClayJugOfDesalinatedWater, "clay jug of desalinated water", "Potable, safe-to-drink water. The water in this clay jug has gone through the desalination process.", "a ");
english.item(ItemType.ClayJugOfMedicinalWater, "clay jug of medicinal water", "A clay jug containing medicinal water, used to cure and soothe certain ailments while also replenishing your thirst.", "a ");
english.item(ItemType.ClayJugOfPurifiedFreshWater, "clay jug of purified fresh water", "A clay jug filled with fresh, purified water. Can be used to quench your thirst.", "a ");
english.item(ItemType.ClayJugOfSeawater, "clay jug of seawater", "Unfiltered seawater, held in a clay jug. Unsuitable to drink in its current form but could be desalinated.", "a ");
english.item(ItemType.ClayJugOfUnpurifiedFreshWater, "clay jug of unpurified fresh water", "A clay jug full of natural, fresh water. Although it is drinkable, further purification is recommended.", "a ");
...
english.item(ItemType.Coconut, "coconut", "A fibrous and heavy fruit. Difficult to consume, but packed with plenty of caloric-dense coconut meat and milk.", "a ");
english.item(ItemType.CompositeBow, "composite bow", "An expertly crafted bow, designed for both velocity and force.", "a ");
english.item(ItemType.CookedBlindfish, "cooked blindfish", "While the source of the food is a bit suspect, after being cooked, it appears to be more palatable.", "a ");
english.item(ItemType.CookedChicken, "cooked chicken", "A well cooked chicken, ready to consume and sure to satisfy.", "a ");
english.item(ItemType.CookedCod, "cooked cod", "A seared, well cooked cod, ready to consume and enjoy.", "a ");
english.item(ItemType.CookedFishSteak, "cooked fish steak", "A cooked fish fillet, seared on the outside and delicious.", "a ");
english.item(ItemType.CookedMeat, "cooked meat", "Adequately heated meat, safe and ready for consumption.");
english.item(ItemType.CookedSpider, "cooked spider", "A crispy spider. Not the best texture or flavor, but contains small bits of white meat inside.", "a ");
...
english.item(ItemType.CordedSling, "corded sling", "A thick piece of cordage, wrapped and bound with a slot made for a projectile. Used to swing ammunition, increasing throwing range.", "a ");
english.item(ItemType.Cork, "cork", "A small cork plug. Crafted from rubbery tree bark; it can be used to contain liquids in bottles and other containers.", "a ");
...
english.item(ItemType.CottonBedroll, "cotton bedroll", "A soft and downy sleeping mattress, rolled up for ease of carrying. Can be used to sleep or rest very comfortably.", "a ");
...
english.item(ItemType.Deadfall, "deadfall", "A large, flat rock, propped up with a stick. Once set, anything that triggers it will be crushed or injured from the falling rock.", "a ");
english.item(ItemType.DeadSpider, "dead spider", "A spider's carcass. It's hard to stomach, even when cooked. Try not to think about what you're eating.", "a ");
english.item(ItemType.DrawnMap, "drawn map", "A paper sheet, scrawled with geographical landmarks and features. Used to approximate a location when read.", "a ");
english.item(ItemType.Earthworm, "earthworm", "A live wriggling insect, effective for bait or eating on its own.", "an ");
...
english.item(ItemType.Egg, "egg", "A brown colored egg, laid by a chicken. Can be eaten as is, or cooked for a tastier meal.", "an ");
english.item(ItemType.ExplosiveTrap, "explosive trap", "A mound of leaves used to conceal a volatile explosive powder. Stepping on it will trigger a small explosion.", "an ");
english.item(ItemType.Feather, "feather", "Some bright white plumage from an avian creature.", "a ");
english.item(ItemType.FeatherBedroll, "feather bedroll", "A bedroll made with soft feathers and wrapped in fabric. Used for resting and sleeping in comfort.", "a ");
english.item(ItemType.FertileSoil, "fertile soil", "A rich soil suitable for adding to plants to promote their fertility.");
english.item(ItemType.FireBladder, "fire bladder", "An oddly shaped organ from a firebreathing creature. Hot to the touch; it appears to contain a deadly chemical reaction inside.", "a ");
english.item(ItemType.FirePlough, "fire plough", "A fire making device which uses a stick and groove method to create heat through friction.", "a ");
english.item(ItemType.FishingNet, "fishing net", "A checkered weave of string with weights on each corner, used to trap and catch fish.", "a ");
english.item(ItemType.FishingRod, "fishing rod", "A flexible, smooth wooden rod with a string line and sharpened hook. Used for fly fishing.", "a ");
english.item(ItemType.Flask, "flask", "A glass container which can be heated to use for desalination, a process used to make seawater drinkable.", "a ");
english.item(ItemType.FlintlockPistol, "flintlock pistol", "A long range, high damage pistol. Requires black powder and bullets to fire.", "a ");
...
english.item(ItemType.ForgeAndAnvil, "forge and anvil", "A combination of a stone forge and anvil. Used in the production of metal armor, weapons, and tools.", "a ");
english.item(ItemType.Fossil, "fossil", "A carbonized fossil of a species long since extinct.", "a ");
english.item(ItemType.Furnace, "furnace", "An enclosed structure made of stone, which traps in the heat to keep a long-lasting, high-temperature fire.", "a ");
english.item(ItemType.Giblets, "giblets", "A batch of cooked animal organs. Considerably repugnant, but nutritious and filling.", "a ");
english.item(ItemType.GlassBottle, "glass bottle", "A transparent vessel with a cork for containment. Used for collecting water.", "a ");
english.item(ItemType.GlassBottleOfDesalinatedWater, "glass bottle of desalinated water", "A bottle filled with clear seawater that has been processed to remove the salt content.", "a ");
english.item(ItemType.GlassBottleOfMedicinalWater, "glass bottle of medicinal water", "A bottled concoction of herbs and nutrients. Used to cure thirst, poisons, and other ailments.", "a ");
english.item(ItemType.GlassBottleOfPurifiedFreshWater, "glass bottle of purified fresh water", "Potable, and safe to hydrate yourself with. The water has been purified reducing any toxins and unsafe bacteria.", "a ");
english.item(ItemType.GlassBottleOfSeawater, "glass bottle of seawater", "Filled to the top with seawater. While seawater is technically drinkable, it will not reduce your thirst.", "a ");
english.item(ItemType.GlassBottleOfUnpurifiedFreshWater, "glass bottle of unpurified fresh water", "A bottle containing water that is likely unfit to drink. It will quench your thirst, but may have negative side-effects until it's purified.", "a ");
...
english.item(ItemType.Grindstone, "grindstone", "A coarse rock useful for sanding, sharpening, and repairing other items.", "a ");
english.item(ItemType.Hammock, "hammock", "A comfortable place to sleep, although not too sturdy. Crafted by bound cordage and usually hung off of the ground.", "a ");
english.item(ItemType.HandDrill, "hand drill", "A rudimentary fire making tool which uses a stick and another piece of wood. Both hands are used to twist the stick against wood, making friction to create an ember for the fire.", "a ");
english.item(ItemType.Inkstick, "inkstick", "A hardened brick of ink, used for drawing and painting.", "an ");
english.item(ItemType.IronArrow, "iron arrow", "An arrow tipped with a high quality iron arrowhead. Fletched with feathers to stabilize flight and accuracy.", "an ");
english.item(ItemType.IronArrowhead, "iron arrowhead", "An expertly forged iron arrowhead, used to create arrows. Alternatively can be used to carve if necessary.", "an ");
english.item(ItemType.IronBoots, "iron boots", "Heavy iron plated boots, shielding your feet from damage.");
english.item(ItemType.IronBreastplate, "iron breastplate", "Durable, armor worn over the torso. One could take a serious beating while wearing this.", "an ");
english.item(ItemType.IronBullet, "iron bullet", "A strong, forged iron bullet. Used as sling or firearm ammunition.", "an ");
english.item(ItemType.IronChest, "iron chest", "A large iron chest that is both roomy and sturdy. Foods contained within will decay at a slower rate.", "an ");
english.item(ItemType.IronDoubleAxe, "iron double axe", "An axe with a forged, double sided head, ideal for both combat and gathering.", "an ");
...
english.item(ItemType.IronGorget, "iron gorget", "A round metal brace worn around the neck and over the shoulders.", "an ");
english.item(ItemType.IronGreaves, "iron greaves", "Iron leggings; to be strapped on and function as leg protection.");
english.item(ItemType.IronHammer, "iron hammer", "A strong hammer with an iron head, perfect for shaping and repairing items.", "an ");
english.item(ItemType.IronHelmet, "iron helmet", "Iron plated headgear designed to withstand heavy blows.", "an ");
english.item(ItemType.IronIngot, "iron ingot", "A solid brick of iron, ready to be formed or melted and cast in many ways.", "an ");
english.item(ItemType.IronLockPick, "iron lock pick", "A pair of iron picks and wrenches, durable enough to pick the most adept of locks.", "an ");
english.item(ItemType.IronOre, "iron ore", "Unprocessed, raw iron ore. Can be smelted into ingots.");
english.item(ItemType.IronPickaxe, "iron pickaxe", "A robust mining implement, with a blade forged from iron.", "an ");
english.item(ItemType.IronShield, "iron shield", "A large and heavy iron shield, used for blocking projectiles or melee attacks.", "an ");
english.item(ItemType.IronShovel, "iron shovel", "A heavy iron digging implement, lifting and breaking through even the toughest gravels and soils.", "an ");
english.item(ItemType.IronSpear, "iron spear", "A polearm with a strong pointed tip forged from iron.", "an ");
english.item(ItemType.IronSword, "iron sword", "A strong, sharp blade designed for thrusting and slashing.", "an ");
english.item(ItemType.IronTongs, "iron Tongs", "Durable iron tongs used to grab hot items, protecting your hands from damage.");
english.item(ItemType.Kiln, "kiln", "Similar to a furnace, but constructed from sandstone. It allows proper heat distribution for crafting glass and clay items.", "a ");
english.item(ItemType.Kindling, "kindling", "A gathering of small twigs and tree matter. A requirement for starting a fire.");
english.item(ItemType.LargeRock, "large rock", "A rather large rock, handy for crafting many tools and devices.", "a ");
english.item(ItemType.LeafBedroll, "leaf bedroll", "A provisional bed with poor insulation and scratchy half-dried leaves, used for sleeping or resting.", "a ");
english.item(ItemType.LeatherBelt, "leather belt", "Made from tanned animal hide, cut, wrapped, and stitched together to tie around the waist.", "a ");
english.item(ItemType.LeatherBoots, "leather boots", "Malleable yet tough foot protection, crafted from tanned animal hide.");
english.item(ItemType.LeatherCap, "leather cap", "A hat made of leather, double layered for extra sturdiness.", "a ");
english.item(ItemType.LeatherGloves, "leather gloves", "Leather-bound hand protection, crafted from tanned animal hide.");
english.item(ItemType.LeatherGorget, "leather gorget", "A circlet of leather, bound in two, stitched together and used as neck protection.", "a ");
english.item(ItemType.LeatherHide, "leather hide", "A fresh leather hide, stripped from an animal and de-furred.", "a ");
...
english.item(ItemType.LeatherQuiver, "leather quiver", "A leather-bound, back-mounted container designed to hold arrows; however, other items will also fit inside as well.", "a ");
english.item(ItemType.LeatherSling, "leather sling", "A sling crafted from tanned leather. Designed to hold a projectile to be thrown at an increased velocity.", "a ");
english.item(ItemType.LeatherTunic, "leather tunic", "A leather garment which provides protection for the torso.", "a ");
english.item(ItemType.Leaves, "leaves", "A handful of foliage used as compost or to stoke a fire.");
english.item(ItemType.Lens, "lens", "Glass formed into a partially convex shape. It allows focusing sunlight into a single location, creating enough heat for a fire.", "a ");
...
english.item(ItemType.LitAnimalFatTorch, "lit animal fat torch", "A bright burning, pleasant smelling torch. Made with a pole and long lasting, rendered animal fat.", "a ");
english.item(ItemType.LitBarkTorch, "lit bark torch", "Provides light to your surroundings when equipped and can also be used to start other fires.", "a ");
english.item(ItemType.LitPoleTorch, "lit pole torch", "A wooden pole that has been lit on fire. Not suitable for long journeys in the darkness.", "a ");
english.item(ItemType.LockPick, "lock pick", "An improvised needle and prong that should be strong enough to pick a lock or two.", "a ");
english.item(ItemType.Log, "log", "A sturdy piece of wood, useful for construction or as a fuel for a fire.", "a ");
english.item(ItemType.LongBow, "long bow", "Nearly as tall as the average person, this bow is designed for maximum range.", "a ");
...
english.item(ItemType.MessageInABottle, "message in a bottle", "An old cloudy bottle with an unidentified object contained inside.", "a ");
english.item(ItemType.MonsterIdol, "monster idol", "A mass of animal organs, crudely shaped into some kind of figure. It smells awful and emits an odd humming noise, and appears to attract creatures.", "a ");
english.item(ItemType.MortarAndPestle, "mortar and pestle", "Used for grinding and crushing, made from smooth stones.", "a ");
...
english.item(ItemType.OldInstructionalScroll, "old instructional scroll", "A tattered sheet of paper with some roughly scribbled instructions and diagrams.", "an ");
english.item(ItemType.OrnateCape, "ornate cape", "A red and gold stitched cape, which drapes the back and fastens at the neck. Worn as a status symbol.", "an ");
english.item(ItemType.OrnateWoodenChest, "ornate wooden chest", "A decorative wooden container gilded with symbols inlaid into the wood.", "an ");
english.item(ItemType.PalmLeaf, "palm leaf", "A large leaf from a palm tree. The strong inner fibers of the leaf are perfect for cordage.", "a ");
english.item(ItemType.PaperMold, "paper mold", "A mold used for making paper. Contains a screen that holds wet recycled fibers to dry and press into flattened, usable paper.", "a ");
english.item(ItemType.PaperSheet, "paper sheet", "A large piece of paper. It appears to contain many recycled fibers. Suitable for drawing on with ink.", "a ");
english.item(ItemType.Peat, "peat", "A dried mass of sponge-like plants, great for fire fuel and composting.");
english.item(ItemType.PeatBandage, "peat bandage", "A fabric bandage combined with peat as an effective antiseptic.", "a ");
...
english.item(ItemType.PileOfAsh, "pile of ash", "The powdery remains of burned matter.", "a ");
english.item(ItemType.PileOfCompost, "pile of compost", "A mix of decaying organic matter and soil, full of chemical nutrients and great for growing plants.", "a ");
english.item(ItemType.PileOfGravel, "pile of gravel", "A large pile of damp stone and sand.", "a ");
english.item(ItemType.PileOfSand, "pile of sand", "A large pile of moist sand, useful for making glass when refined.", "a ");
english.item(ItemType.PileOfSnow, "pile of snow", "A melting snow pile. Useful to drink in desperate need, but be quick!", "a ");
english.item(ItemType.Pineapple, "pineapple", "A juicy, ripe pineapple, loaded with vitamins and thirst-quenching attributes.", "a ");
...
english.item(ItemType.Raft, "raft", "A small, simple boat; a quicker alternative to swimming. Effective for traversing large expanses of water.", "a ");
english.item(ItemType.RawBlindfish, "raw blindfish", "An odd looking fish with no eyes. Very slimy to the touch.", "a ");
english.item(ItemType.RawChicken, "raw chicken", "A small, plump and de-feathered chicken carcass, ready for cooking.", "a ");
english.item(ItemType.RawClay, "raw clay", "A soft, formable mud. Suitable for building materials, tool-making, and more.");
english.item(ItemType.RawClayBlowpipe, "raw clay blowpipe", "An unfired clay blowpipe used in glassblowing. Unusable until it has been fired.", "a ");
english.item(ItemType.RawClayBrick, "raw clay brick", "A soft piece of raw clay, molded into a rectangle. Ready to be fired inside a kiln.", "a ");
english.item(ItemType.RawClayJug, "raw clay jug", "A formed and sculpted jug molded from raw clay. Requires a cork and a kiln to be fired and hardened.", "a ");
english.item(ItemType.RawCod, "raw cod", "Slimy to the touch, but healthy and delicious to eat. Can be cooked for a better meal.", "a ");
english.item(ItemType.RawFishSteak, "raw fish steak", "A raw piece of fish, cut into a fillet. Good to eat as is, but is tastier cooked.", "a ");
...
english.item(ItemType.RollOfRedCarpet, "roll of red carpet", "A rolled up piece of red carpet, suitable for making a comfortable living space or welcoming important guests.", "a ");
english.item(ItemType.Rope, "rope", "A thick, twisted piece of cordage, useful for heavy-duty binding.", "a ");
...
english.item(ItemType.Sail, "sail", "A large piece of fabric, woven together to be attached to a mast. Used on a sailboat to propel it along the sea.", "a ");
english.item(ItemType.Sailboat, "sailboat", "A large one-man boat. Used to traverse large expanses of water and for travel back to civilization.", "a ");
...
english.item(ItemType.SandCastFlask, "sand cast flask", "A mold for casting metal into any shape, made with green sand.", "a ");
...
english.item(ItemType.SandstoneWall, "sandstone wall", "A constructed wall built from mined sandstone.", "a ");
english.item(ItemType.Sapling, "sapling", "A young, fertile tree, suitable for replanting.", "a ");
...
english.item(ItemType.SharpenedBone, "sharpened bone", "A sharp bone, useful for carving other objects.", "a ");
english.item(ItemType.SharpGlass, "sharp glass", "A semi-opaque shard of glass, formed after melting sand down.");
english.item(ItemType.SharpRock, "sharp rock", "A sharpened rock, useful for crafting, tool making, and carving when required.", "a ");
english.item(ItemType.SheetOfGlass, "sheet of glass", "A cloudy tempered piece of glass. Practical for many optical tools and other simple devices used to harness the sun.", "a ");
english.item(ItemType.ShortBow, "short bow", "A bow designed for powerful shots at close range.", "a ");
english.item(ItemType.Sinew, "sinew", "Strong and flexible animal tissue. Commonly used for making bows or simple cordage.");
english.item(ItemType.SkeletalMageWand, "skeletal mage wand", "A mysterious, gnarled staff with a twinkling red gemstone attached to the end.", "a ");
english.item(ItemType.Skullcap, "skullcap", "A hollowed-out animal skull, useful as a provisional helmet.", "a ");
...
english.item(ItemType.SmallBag, "small bag", "A leather pouch used for holding a few items, carried at your waist, reducing encumbrance.", "a ");
english.item(ItemType.SmoothRock, "smooth rock", "A round, smoothed rock, useful for many crafts.", "a ");
english.item(ItemType.Snare, "snare", "A short pole pushed into the ground with a string attached. Designed to ensnare creatures in its slipknot.", "a ");
english.item(ItemType.Soil, "soil", "A pile of moist dirt. The heavy smell of earth permeates your nostrils when holding it.");
english.item(ItemType.SolarStill, "solar still", "A still that collects condensation and filters it into in a hole beneath the glass, desalinating the water and draining it into a container.", "a ");
...
english.item(ItemType.SpottedRedMushroom, "spotted red mushroom", "An odd looking, foul smelling mushroom.", "a ");
english.item(ItemType.Spyglass, "spyglass", "An improvised, short-range telescope, which can be used to see slightly further away in any direction when equipped.", "a ");
english.item(ItemType.StoneArrowhead, "stone arrowhead", "Crafted from stone and to be used in the crafting of arrows. Could also be used as a carving implement.", "a ");
english.item(ItemType.StoneAxe, "stone axe", "A dual-use tool which is both sharp and blunt. Can be used to chop wood or mine stone with ease.", "a ");
english.item(ItemType.StoneBullet, "stone bullet", "A basic stone projectile for slings and firearms. Smooth and more or less spherical in shape.", "a ");
english.item(ItemType.StoneHammer, "stone hammer", "A rudimentary stone hammer, braced on the end of a pole with string. Used for gathering and repairing.", "a ");
english.item(ItemType.StoneKnife, "stone knife", "A sharpened piece of stone, carved into a blade, with a handle for support. Can be used as a weapon, gathering tool or to carve.", "a ");
english.item(ItemType.Stones, "stones", "A mass of small rocks. Can be used for throwing or crafting.");
english.item(ItemType.StoneShovel, "stone shovel", "A digging tool made of stone, used to collect different materials from the ground or to route water.", "a ");
english.item(ItemType.StoneSpear, "stone spear", "A hunting weapon crafted with a stone head, suitable as a throwing weapon.", "a ");
english.item(ItemType.StoneWall, "stone wall", "A series of interlaced stones and rocks, shaped into a vertical wall structure. Can be built to keep enemies out.", "a ");
english.item(ItemType.StoneWaterStill, "stone water still", "A hollowed out rock with a stone lid. It's used to desalinate water by boiling it and then collecting the steam into a separate container.", "a ");
...
english.item(ItemType.Sundial, "sundial", "A stone timepiece that uses the location of the sun or moon to show the approximate time of day or night.", "a ");
english.item(ItemType.Suture, "suture", "A sharp needle tool with an attached thin string, used to sew and close gaping wounds.", "a ");
...
english.item(ItemType.TatteredMap, "tattered map", "An old torn map covered with drawings and scribbles, a bit hard to make sense of on first glance.", "a ");
english.item(ItemType.TatteredPants, "tattered pants", "Brown colored pants, now reduced to shorts from distress and wear.");
english.item(ItemType.TatteredShirt, "tattered shirt", "A once fine piece of a clothing, now torn and tattered.", "a ");
...
english.item(ItemType.Tourniquet, "tourniquet", "A hard stud twisted together with a string. Used to twist around a bleeding wound to stem the flow of blood.", "a ");
...
english.item(ItemType.VenomGland, "venom gland", "The venom producing gland of a snake, still filled with some immobilizing venom.", "a ");
english.item(ItemType.Vine, "vine", "A long, winding tree vine, suitable for cordage.", "a ");
...
english.item(ItemType.VineWhip, "vine whip", "A makeshift weapon made simply with tree vines wrapped together.", "a ");
english.item(ItemType.Waterskin, "waterskin", "A portable water container, made from stitched leather.", "a ");
english.item(ItemType.WaterskinOfDesalinatedWater, "waterskin of desalinated water", "A waterskin full of freshly desalinated seawater.", "a ");
english.item(ItemType.WaterskinOfMedicinalWater, "waterskin of medicinal water", "A soothing mixture of plants and roots. Used to heal poisons and illnesses.", "a ");
english.item(ItemType.WaterskinOfPurifiedFreshWater, "waterskin of purified fresh water", "A full waterskin of fresh, safe-to-drink water.", "a ");
english.item(ItemType.WaterskinOfSeawater, "waterskin of seawater", "A waterskin full of seawater, not suitable for drinking without desalination.", "a ");
english.item(ItemType.WaterskinOfUnpurifiedFreshWater, "waterskin of unpurified fresh water", "Unpurified and possibly hazardous water. It is recommended you purify the water before drinking.", "a ");
english.item(ItemType.WhiteMushrooms, "white mushrooms", "Edible, long lasting mushrooms. They appear safe to consume.");
english.item(ItemType.WildOnion, "wild onion", "A strong smelling and tasting plant, packed with nutrients and vitamins.", "a ");
english.item(ItemType.WoodenArrow, "wooden arrow", "A provisional wooden projectile to be fired from a bow. Crafted with a feather to control flight.", "a ");
english.item(ItemType.WoodenChest, "wooden chest", "A large wooden container that can fit many items while placed on the ground. Foods will decay slower within it.", "a ");
english.item(ItemType.WoodenDoor, "wooden door", "A door crafted from long wooden planks with large wooden hinges. Can be opened and closed when built.", "a ");
english.item(ItemType.WoodenFence, "wooden fence", "A section of wooden fencing, constructed from three logs and held together with horizontal beams.", "a ");
english.item(ItemType.WoodenFlooring, "wooden flooring", "Wooden floor boards; planed to equal height and length.");
english.item(ItemType.WoodenGate, "wooden gate", "A gate crafted from long wooden planks with small wooden hinges. Can be opened and closed when built.", "a ");
english.item(ItemType.WoodenPole, "wooden pole", "A long piece of wood, carved and shaved down into a smooth rod from a branch or log. ", "a ");
english.item(ItemType.WoodenSpear, "wooden spear", "A makeshift, easy to craft hunting weapon. Makes for an ideal ranged weapon.", "a ");
english.item(ItemType.WoodenTongs, "wooden tongs", "A pair of simple wood tongs, used to pick up hot objects without injury.");
english.item(ItemType.WoodenWall, "wooden wall", "A sturdy set of bound logs, forming a protective wall that can be placed.", "a ");
...
english.item(ItemType.WroughtIronArrow, "wrought iron arrow", "An arrow with a wrought iron arrowhead. The shaft of the arrow is long and is fletched with feathers.", "a ");
english.item(ItemType.WroughtIronArrowhead, "wrought iron arrowhead", "Forged with wrought iron, this arrowhead is used to craft an arrow. In dire need, it could also be used for carving.", "a ");
...
english.item(ItemType.WroughtIronBreastPlate, "wrought iron breastplate", "A large wrought iron chest plate, worn over the torso.", "a ");
english.item(ItemType.WroughtIronBullet, "wrought iron bullet", "A small ball of wrought iron, used as ammunition for slingshots or firearms.", "a ");
english.item(ItemType.WroughtIronChest, "wrought iron chest", "A spacious container built from wrought iron that can store many items. Foods will spoil slower inside of it.", "a ");
english.item(ItemType.WroughtIronDoubleAxe, "wrought iron double axe", "A dual-bladed axe which can provide enough slashing damage for both combat and gathering.", "a ");
...
english.item(ItemType.WroughtIronGorget, "wrought iron gorget", "A molded piece of metal, used to protect the area around the neck and shoulders.", "a ");
...
english.item(ItemType.WroughtIronHammer, "wrought iron hammer", "A large mallet crafted from wrought iron. Useful for repairing and sometimes gathering.", "a ");
english.item(ItemType.WroughtIronHelmet, "wrought iron helmet", "Using a barbute design, this iron helmet shields the head from most kinds of attacks.", "a ");
english.item(ItemType.WroughtIronLockPick, "wrought iron lock pick", "A set of picks and wrenches made from wrought iron, used for picking and unlocking locked devices.", "a ");
english.item(ItemType.WroughtIronPickaxe, "wrought iron pickaxe", "A dual-headed mining implement. One head is heavy and blunt, the other, spiked to cut through rock with ease.", "a ");
english.item(ItemType.WroughtIronShield, "wrought iron shield", "A sturdy wrought iron shield, made by bending large sheets of metal into shape.", "a ");
english.item(ItemType.WroughtIronShovel, "wrought iron shovel", "A shovel with an angled, pointed head, useful for digging and water routing.", "a ");
english.item(ItemType.WroughtIronSpear, "wrought iron spear", "A polearm with pointed head, crafted from wrought iron. Used in melee or thrown in combat.", "a ");
english.item(ItemType.WroughtIronSword, "wrought iron sword", "A long, sharpened blade fitted into a solid hilt and forged from wrought iron. A good, strong weapon.", "a ");
...
// Groups
english.itemGroup(ItemTypeGroup.Arrow, "arrow", "an ");
english.itemGroup(ItemTypeGroup.Bedding, "bedding", "a ", " item");
english.itemGroup(ItemTypeGroup.Bone, "bone", "a ");
english.itemGroup(ItemTypeGroup.Bullet, "bullet", "a ");
english.itemGroup(ItemTypeGroup.Carbon, "carbon", "a ", " item");
english.itemGroup(ItemTypeGroup.ClayJugOfPotableWater, "clay jug of potable water", "a ");
english.itemGroup(ItemTypeGroup.Compost, "compost", "a ", " item");
english.itemGroup(ItemTypeGroup.Container, "container", "a ");
english.itemGroup(ItemTypeGroup.ContainerOfDesalinatedWater, "container of desalinated water", "a ");
english.itemGroup(ItemTypeGroup.ContainerOfMedicinalWater, "container of medicinal water", "a ");
english.itemGroup(ItemTypeGroup.ContainerOfPurifiedFreshWater, "container of purified fresh water", "a ");
english.itemGroup(ItemTypeGroup.ContainerOfSeawater, "container of seawater", "a ");
english.itemGroup(ItemTypeGroup.ContainerOfUnpurifiedFreshWater, "container of unpurified fresh water", "a ");
english.itemGroup(ItemTypeGroup.CookedMeat, "cooked meat", "a ", " item");
english.itemGroup(ItemTypeGroup.Cordage, "cordage", "a ", " item");
english.itemGroup(ItemTypeGroup.Equipment, "equipment", "an ", " item");
english.itemGroup(ItemTypeGroup.Fabric, "fabric", "a ", " item");
english.itemGroup(ItemTypeGroup.Firemaking, "firemaking", "a ", " item");
english.itemGroup(ItemTypeGroup.Food, "food", "a ", " item");
english.itemGroup(ItemTypeGroup.Fuel, "fuel", "a ", " item");
english.itemGroup(ItemTypeGroup.Gardening, "gardening", "a ", " item");
english.itemGroup(ItemTypeGroup.GlassBottleOfPotableWater, "glass bottle of potable water", "a ");
english.itemGroup(ItemTypeGroup.Hammer, "hammer", "a ");
english.itemGroup(ItemTypeGroup.Health, "health", "a ", " item");
english.itemGroup(ItemTypeGroup.Heating, "heating", "a ", " item");
english.itemGroup(ItemTypeGroup.Housing, "housing", "a ", " item");
english.itemGroup(ItemTypeGroup.Insect, "insect", "an ");
english.itemGroup(ItemTypeGroup.LightSource, "light source", "a ");
english.itemGroup(ItemTypeGroup.Meat, "meat", "a ", " item");
english.itemGroup(ItemTypeGroup.Medicinal, "medicinal", "a ", " item");
english.itemGroup(ItemTypeGroup.Needle, "needle", "a ");
english.itemGroup(ItemTypeGroup.Other, "other", "an ", " item");
english.itemGroup(ItemTypeGroup.Pole, "pole", "a ");
english.itemGroup(ItemTypeGroup.Powder, "powder", "a ");
english.itemGroup(ItemTypeGroup.Preservative, "preservative", "a ");
english.itemGroup(ItemTypeGroup.Pulp, "pulp", "a ", " item");
english.itemGroup(ItemTypeGroup.RawMeat, "raw meat", "a ", " item");
english.itemGroup(ItemTypeGroup.Reinforce, "reinforce", "a ", " item");
english.itemGroup(ItemTypeGroup.Repair, "repair", "a ", " item");
english.itemGroup(ItemTypeGroup.Rock, "rock", "a ");
english.itemGroup(ItemTypeGroup.Sharpened, "sharpened", "a ", " item");
english.itemGroup(ItemTypeGroup.SharpenedRock, "sharpened rock", "a ");
english.itemGroup(ItemTypeGroup.Skewer, "skewer", "a ");
english.itemGroup(ItemTypeGroup.Storage, "storage", "a ", " item");
english.itemGroup(ItemTypeGroup.Tongs, "tongs", "");
english.itemGroup(ItemTypeGroup.Tool, "tool", "a ");
english.itemGroup(ItemTypeGroup.Transmogrify, "transmogrify", "a ", " item");
english.itemGroup(ItemTypeGroup.Trap, "trap", "a ");
english.itemGroup(ItemTypeGroup.Travel, "travel", "a ", " item");
english.itemGroup(ItemTypeGroup.Treasure, "treasure", "a ");
english.itemGroup(ItemTypeGroup.Water, "water", "a ", " item");
english.itemGroup(ItemTypeGroup.WaterskinOfPotableWater, "waterskin of potable water", "a ");
english.itemGroup(ItemTypeGroup.Weapon, "weapon", "a ");

// Doodads
english.doodad(DoodadType.Acid, "acid");
english.doodad(DoodadType.BarePalmTree, "bare palm tree", "a ");
english.doodad(DoodadType.BareTree, "bare tree", "a ");
english.doodad(DoodadType.BerryBush, "berry bush", "a ");
english.doodad(DoodadType.Cacti, "cacti");
english.doodad(DoodadType.Campfire, "campfire", "a ");
english.doodad(DoodadType.CaveEntrance, "cave entrance", "a ");
english.doodad(DoodadType.ClayBrickWall, "clay brick wall", "a ");
english.doodad(DoodadType.Cotton, "cotton");
english.doodad(DoodadType.DeadBush, "dead bush", "a ");
english.doodad(DoodadType.ForgeAndAnvil, "forge and anvil", "a ");
english.doodad(DoodadType.Furnace, "furnance", "a ");
english.doodad(DoodadType.GrowingGrass, "growing grass");
english.doodad(DoodadType.GrowingMushroom, "growing mushroom", "a ");
english.doodad(DoodadType.GrowingPlant, "growing plant", "a ");
english.doodad(DoodadType.IronChest, "iron chest", "an ");
english.doodad(DoodadType.Kiln, "kiln", "a ");
english.doodad(DoodadType.LitCampfire, "lit campfire", "a ");
english.doodad(DoodadType.LitForgeAndAnvil, "lit forge and anvil", "a ");
english.doodad(DoodadType.LitFurnace, "lit furnance", "a ");
english.doodad(DoodadType.LitKiln, "lit kiln", "a ");
english.doodad(DoodadType.LitStoneWaterStill, "lit stone water still", "a ");
english.doodad(DoodadType.LitTorchStand, "lit torch stand", "a ");
english.doodad(DoodadType.LockedWoodenChest, "locked wooden chest", "a ");
english.doodad(DoodadType.MonsterIdol, "monster idol", "a ");
english.doodad(DoodadType.OrnateWoodenChest, "ornate wooden chest", "an ");
english.doodad(DoodadType.PalmTree, "palm tree", "a ");
english.doodad(DoodadType.PalmTreeWithCoconuts, "palm tree with coconuts", "a ");
english.doodad(DoodadType.PileOfRocks, "pile of rocks", "a ");
english.doodad(DoodadType.PineapplePlant, "pineapple plant", "a ");
english.doodad(DoodadType.PoisonIvy, "poison ivy");
english.doodad(DoodadType.SandstoneWall, "sandstone wall ", "a ");
english.doodad(DoodadType.Sapling, "sapling", "a ");
english.doodad(DoodadType.Seaweed, "seaweed");
english.doodad(DoodadType.SetDeadfall, "set deadfall", "a ");
english.doodad(DoodadType.SetExplosiveTrap, "set explosive trap", "a ");
english.doodad(DoodadType.SetHobgoblinSnare, "set hobgoblin snare", "a ");
english.doodad(DoodadType.SetSnare, "set snare", "a ");
english.doodad(DoodadType.SolarStill, "solar still", "a ");
english.doodad(DoodadType.SpottedRedMushroom, "spotted red mushroom", "a ");
english.doodad(DoodadType.StoneWall, "stone wall", "a ");
english.doodad(DoodadType.StoneWaterStill, "stone water still", "a ");
english.doodad(DoodadType.TallGrass, "tall grass");
english.doodad(DoodadType.Thistles, "thistles");
english.doodad(DoodadType.TorchStand, "torch stand", "a ");
english.doodad(DoodadType.Tree, "tree", "a ");
english.doodad(DoodadType.TreeWithBerries, "tree with berries", "a ");
english.doodad(DoodadType.TreeWithFungus, "tree with fungus", "a ");
english.doodad(DoodadType.TreeWithVines, "tree with vines", "a ");
english.doodad(DoodadType.Vines, "vines");
english.doodad(DoodadType.WhiteMushrooms, "white mushrooms");
english.doodad(DoodadType.WildOnion, "wild onion", "a ");
english.doodad(DoodadType.WoodenChest, "wooden chest", "a ");
english.doodad(DoodadType.WoodenDoor, "wooden door", "a ");
english.doodad(DoodadType.WoodenDoorOpen, "open wooden door", "an ");
english.doodad(DoodadType.WoodenFence, "wooden fence", "a ");
english.doodad(DoodadType.WoodenGate, "wooden gate", "a ");
english.doodad(DoodadType.WoodenGateOpen, "open wooden gate", "an ");
english.doodad(DoodadType.WoodenWall, "wooden wall", "a ");
english.doodad(DoodadType.WroughtIronChest, "wrought iron chest", "a ");
english.doodad(DoodadType.YellowFlowers, "yellow flowers");
...
english.terrain(TerrainType.BarePalmTree, "bare palm tree", "a ");
english.terrain(TerrainType.BareTree, "bare tree", "a ");
english.terrain(TerrainType.CaveEntrance, "cave entrance", "a ");
...
english.terrain(TerrainType.PalmTree, "palm tree", "a ");
english.terrain(TerrainType.PalmTreeWithCoconuts, "palm tree with coconuts", "a ");
...
english.terrain(TerrainType.Tree, "tree", "a ");
english.terrain(TerrainType.TreeWithBerries, "tree with berries", "a ");
english.terrain(TerrainType.TreeWithFungus, "tree with fungus", "a ");
english.terrain(TerrainType.TreeWithVines, "tree with vines", "a ");
...
// Monsters
english.monster(MonsterType.AcidSpitterDemon, "acid spitter demon", "an ");
english.monster(MonsterType.Bear, "bear", "a ");
english.monster(MonsterType.Blindfish, "blindfish", "a ");
english.monster(MonsterType.Bogling, "bogling", "a ");
english.monster(MonsterType.Chicken, "chicken", "a ");
english.monster(MonsterType.ClawWorm, "claw worm", "a ");
english.monster(MonsterType.Cod, "cod", "a ");
english.monster(MonsterType.Drake, "drake", "a ");
english.monster(MonsterType.FireElemental, "fire elemental", "a ");
english.monster(MonsterType.GiantRat, "giant rat", "a ");
english.monster(MonsterType.GiantSpider, "giant spider", "a ");
english.monster(MonsterType.GreyWolf, "grey wolf", "a ");
english.monster(MonsterType.Harpy, "harpy", "a ");
english.monster(MonsterType.Hobgoblin, "hobgoblin", "a ");
english.monster(MonsterType.Imp, "imp", "an ");
english.monster(MonsterType.JellyCube, "jelly cube", "a ");
english.monster(MonsterType.Kraken, "kraken", "a ");
english.monster(MonsterType.LivingMushroom, "living mushroom", "a ");
english.monster(MonsterType.LivingRock, "living rock", "a ");
english.monster(MonsterType.PirateGhost, "pirate ghost", "a ");
english.monster(MonsterType.Rabbit, "rabbit", "a ");
english.monster(MonsterType.Rat, "rat", "a ");
english.monster(MonsterType.Shark, "shark", "a ");
english.monster(MonsterType.SkeletalMage, "skeletal mage", "a ");
english.monster(MonsterType.Skeleton, "skeleton", "a ");
english.monster(MonsterType.Slime, "slime", "a ");
english.monster(MonsterType.Snake, "snake", "a ");
english.monster(MonsterType.TimeSkitter, "time skitter", "a ");
english.monster(MonsterType.TrapdoorSpider, "trapdoor spider", "a ");
english.monster(MonsterType.VampireBat, "vampire bat", "a ");
english.monster(MonsterType.Zombie, "zombie", "a ");
...
english.hint(HintType.CorpseCarving, "Corpse Carving", "To harvest potential resources from this corpse, try carving it with a sharp item. Choose \"Carve\" from the item's menu or try moving it to a quickslot for ease of use.");
...
english.hint(HintType.CaveDarkness, "Cave Darkness", "This would be the perfect place for hidden treasure, but first, the area may need illumination with fire or a torch.");
english.hint(HintType.Nightfall, "Nightfall", "Nightfall approaches! Find a safe area to camp out and prepare yourself for combat! Many tough creatures prowl the night.");
...
english.hint(HintType.HealthProblems, "Health Problems", "You are quite injured, replenish your health with food or healing-type items. Some status effects reduce your ability to regenerate your health including Bleeding and Poisoning. Alternatively, you can also try sleeping or resting to regenerate health.");
...
english.hint(HintType.Poisoned, "Poisoned", "You have been poisoned! Poisoning can happen from eating bad things or from some types of creatures. Make sure to consume a curing item to cure the poison, such as a Medicinal Water. Poisoning causes you to starve/dehydrate faster, regenerate stamina slower, and stops regeneration of health.");
...
english.hint(HintType.Death, "Death", "Death is permanent. Although you have died, all of the crafting recipes you have discovered will be ready on your next playthrough. Your milestones will also carry over, providing you multiple starting benefits.");
english.hint(HintType.ConsumingBadThings, "Consuming Bad Things", "Ow! Consuming that has hurt you! Not all edible/drinkable objects should be consumed, at least not without facing the consequences. On the other hand, sometimes it's worth the risk to gain it's other effects. Consuming bad things can sometimes result in poisoning.");
...
english.hint(HintType.Burned, "Burn Injuries", "You have been burned! These lasting injuries and pain can be caused from stepping in an open flame without protection, or possibly other sources. Pouring liquid on yourself will soothe the injuries and pain. Alternatively, you can also take a swim in deep water. Keep swimming until the effect subsides. Being burned will stop you from regenerating health and can last awhile if untreated.");
