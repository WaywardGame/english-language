import {
	...
	KeyBind, OnEquipType as OnEquip, SkillType as Skill, TerrainType as Terrain
} from "Enums";
import { Dictionary, GrowthStageTranslation as GrowingStage, UiMessage as Ui, UiMessageStatic as UiStatic } from "language/ILanguage";
...
english.setDictionary(Dictionary.Doodad, {
	...
	[DoodadGroup.Tree]: ["a", "tree"],
	[DoodadGroup.Fungi]: ["", "fungi"]
});
...
english.setDictionary(Dictionary.Item, {
	...
	[Item.CypressCone]: ["a", "cypress cone", "A rounded cone from a spruce tree, containing seeds."],
...
english.setDictionary(Dictionary.Message, {
	...
	[Message.AttemptToTill]: "You attempt to till the _0_, but do not produce any results yet.",
	...
	[Message.CreatureIsAtPercentHealth]: "Your high anatomy skill reveals the creature is at _0_% health.",
	[Message.CreatureIsBarelyHurt]: "Your anatomy skill reveals with high accuracy that the creature is barely hurt.",
	[Message.CreatureIsHealthy]: "Your anatomy skill reveals with low accuracy that the creature is healthy.",
	[Message.CreatureIsHealthyAndUndamaged]: "Your anatomy skill reveals with high accuracy that the creature is healthy and fairly undamaged.",
	[Message.CreatureIsHurt]: "Your anatomy skill reveals with moderate accuracy that the creature is hurt.",
	[Message.CreatureIsInjured]: "Your anatomy skill reveals with high accuracy that the creature is injured.",
	[Message.CreatureIsnhealthy]: "Your anatomy skill reveals with low accuracy that the creature is unhealthy",
	[Message.CreatureIsSeverelyDamaged]: "Your anatomy skill reveals with high accuracy that the creature looks severely damaged.",
	[Message.CreatureIsUnharmed]: "Your anatomy skill reveals with moderate accuracy that the creature is unharmed.",
	[Message.CreatureIsVeryInjured]: "Your anatomy skill reveals with moderate accuracy that the creature is very injured.",
	...
	[Message.Water]: "water",
	[Message.WaterHelpGrow]: "You used the water to help _0_ grow.",
	...
	[Message.YouNoticeLavaTurn]: "You notice lava turning to ash.",
...
english.setDictionary(Dictionary.Skill, {
	[Skill.Anatomy]: ["Anatomy", "<li>Increases accuracy of creature health description.</li><li>Decreases chance of bleeding, poisoning, and burning pain from creatures.</li><li>Increases effectiveness of healing consumables.</li><li>Increases success chance when healing.</li><li>Decreases chance of bleeding when using bare hands during combat/gathering.</li>"],
	...
	[Skill.Taming]: ["Taming", "<li>Increases chance of successfully taming a creature.</li><li>Increases length of time creature will be tamed for.</li><li>Decreases chance of stamina reduction when taming/offering.</li>"],
...
english.setDictionary(Dictionary.UiStatic, {
	...
	[UiStatic.MenuNewGameOptions]: "Game Options",
	[UiStatic.MenuNewGameOptionsAccept]: "Accept",
	[UiStatic.MenuNewGameOptionsCasual]: "Casual Mode",
	[UiStatic.MenuNewGameOptionsCasualDescription]: "Dying will respawn you in the last place you rested or slept. All items will be dropped at the location of your demise.",
	[UiStatic.MenuNewGameOptionsHardcore]: "Hardcore Mode",
	[UiStatic.MenuNewGameOptionsHardcoreDescription]: "The default and definitive way to play. Permanent character death is enabled.",
	[UiStatic.MenuNewGameOptionsMessage]: "Choose Your Settings",
	...
	[UiStatic.OptionsDirectionTurnDelay]: "Direction Turn Delay",
	[UiStatic.OptionsDirectionTurnDelayTooltip]: "The amount of movement delay that occurs after switching a direction or turning.",
...
english.setDictionary(Dictionary.Ui, {
	[Ui.AreYouSureYouWantToReleaseCreature]: "Are you sure you want to release _0_?",
	...
	[Ui.AreYouSureYouWantToWhileOnFire]: "Are you sure you want to _0_ while _1_ is on fire?",
	...
	[Ui.FailedToSaveGame]: `Failed to save the game. Please create a topic and send us your logs on the <a href="https://steamcommunity.com/app/379210/discussions/1/">Bug Reports Forum</a>`,
	...
	[Ui.MultiplayerFailedToLoadMods]: `Unable to join server<br />Failed to load required mods<br />_0_`,
	...
	[Ui.No]: "No",
	[Ui.NoGatherAreYouSureYouWantToDestroy]: "_0_ is not ready to gather yet, are you sure you want to destroy it?",
	[Ui.Ok]: "OK",
	...
	[Ui.WaterDoesNotNeedDesalination]: "This water does not need to undergo the desalination process. Do you want to still want to pour it in the still to purify?",
