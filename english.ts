...
english.setDictionary(Dictionary.Item, {
	...
	[Item.BundleOfSwitchgrass]: ["a", "bundle of switchgrass", "Bundled up switchgrass stalks, complete with its seeds."],
	[Item.BushelOfWheat]: ["a", "bushel of wheat", "The clipped remains of the stalk and grains from wheat grass."],
	...
	[Item.ClayJugOfGoatMilk]: ["a", "clay jug of goat milk", "A clay jug full of nutritious raw goat milk."],
	...
	[Item.GlassBottleOfGoatMilk]: ["a", "glass bottle of goat milk", "A bottled batch of goat milk, filled to the top of this glass bottle."],
	...
	[Item.SheafOfHay]: ["", "sheaf of hay", "Long and almost sharp to the touch. These grass stalks are perfect for string making, animal feed, or tinder when dried."],
	...
	[Item.WaterskinOfGoatMilk]: ["a", "waterskin of goat milk", "A filled leather waterskin containing the raw milk from a goat."],
...
english.setDictionary(Dictionary.Message, {
	...
	[Message.CreatureResistanceVulnerableModerate]: "Your moderate anatomy skill reveals it is resistant to _0_ damage types and vulnerable to _1_ damage types.",
