...
english.ui(Languages.UiTranslation.OptionsEnableMouseMovement, "Mouse Movement");
...
english.hint(HintType.Burning, "Burning Pain", "You have been burned! This lasting burning pain can be caused from stepping in an open flame without protection, or possibly other sources. Using a curing item such as a Charcoal Bandage or Medicinal Water will help soothe the pain. Alternatively, take a swim in deep water for a bit to remove the pain. Keep swimming until the effect subsides. Burning pain will stop you from regenerating health and can last quite awhile if untreated.");
